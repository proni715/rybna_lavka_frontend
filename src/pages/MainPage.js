  ...
  return (
    <div>
      ...
      <div id="index-banner" className="parallax-container">
        <div className="section no-pad-bot">
          <div className="container">
            <br />
            <br />
            <h1 className="header center teal-text text-lighten-1">
              Rybna Lavka
            </h1>
        ...
        <div className="parallax">
          <img src="../../background.jpg" alt="Unsplashed background img 1" />
        </div>
      </div>
      <div className="container">
      ...
      <div className="parallax-container valign-wrapper">
        ...
        <div className="parallax">
          <img src="../../background.jpg" alt="Unsplashed background img 2" />
        </div>
      </div>
      <div className="container">
        <div className="section">
      ...
      <div className="parallax-container valign-wrapper">
        ...
        <div className="parallax">
          <img src="../../background.jpg" alt="Unsplashed background img 3" />
        </div>
      </div>
    </div>
  );
